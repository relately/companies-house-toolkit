...
export const parseTransaction = (line: string): Transaction => {
  ...
  switch (data.transactionType) {
    ...
    default:
      throw Error(`Unknown transaction type: ${data.transactionType}`);
  }
};
...
export const parseLine = (line: string): TransactionLine => ({
  ...
  'accountingReferenceDate.day': line.substring(68, 70).trim(),
  'accountingReferenceDate.month': line.substring(70, 72).trim(),
