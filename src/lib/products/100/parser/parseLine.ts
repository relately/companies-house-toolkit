...
export const parseTransaction = (line: string): Product100Transaction => {
...
export const parseLine = (line: string): Product100Record => ({
  ...
  address: {
    careOf: line.substring(349, 449).trim(),
    poBox: line.substring(449, 459).trim(),
    addressLine1: line.substring(459, 491).trim(),
    addressLine2: line.substring(491, 523).trim(),
    addressLine3: line.substring(523, 555).trim(),
    addressLine4: line.substring(555, 587).trim(),
  },
});
