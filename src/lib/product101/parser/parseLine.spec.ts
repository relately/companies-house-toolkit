...
import { Product101Record } from './types.js';
  ...
  it('should handle "Restoration"', () => {
    ...
    const expected = {
      ...
      address: {
        ...
        careOf: '',
        country: 'NORTHERN IRELAND',
        houseNameOrNumber: 'UNIT 5',
        poBox: '',
        postTown: 'ARMAGH',
        postcode: 'BT60 1HW',
        region: '',
        street: 'ARMAGH BUSINESS PARK',
        suppliedCompanyName: '',
      },
      alphaKey: 'ALCHEMEU',
...
describe('parseLine', () => {
  it('should pull out the parts of a line', () => {
    ...
    const expected: Product101Record = {
      companyNumber: 'NC001715',
      transactionType: '01',
      correctionMarker: '',
      gazettableDocumentType: 'B1',
